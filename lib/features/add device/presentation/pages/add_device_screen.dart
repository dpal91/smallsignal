    ...
    return Scaffold(
      ...
      body: BlocConsumer<AddDeviceBloc, AddDeviceState>(
        listener: (context, state) {
          if (state is AddDeviceState) {
            print("Status: ${state.status} device: ${state.devices} ");
          }
        },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  WifiScannerScreen(
                    iswifiEnabled: state.status != WifiStatus.disabled,
                    isScanning: state.status == WifiStatus.scanning,
                  ),
